...
public class AddressProcessor extends AbstractElementTagProcessor {
	private static final String TAG_NAME = "addressList";// 标签名
	private static final String PAGE_SIZE = "pageSize";
	private static final String PAGE_NUM = "pageNum";
	public static final int PRECEDENCE = 200;

	public AddressProcessor(String dialectPrefix) {
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag,
        ...
        MemberAddressService memberAddrService = appCtx.getBean(MemberAddressService.class);
		...
		example.createCriteria().andEqualTo("memberId", StpMemberUtil.getLoginIdAsInt());
		PageInfo<?> pageInfo = this.selectByPageNumSize(queryRequest, () -> memberAddrService.selectByExample(example));
